...
- Current capability: Phase 8D added local template content QA, trial template selection, trial content readiness checks, and administrator content QA panels after Phase 8C added the local MVP trial pack.
...
- nextRecommendedPhaseName: MVP Release Readiness Gate
- project role: Makeup template production system with a local contract-driven user app shell prototype, not a production user app
- current capability: React Web / PWA MVP first is selected; Phase 8B local PWA/mobile shell polish, Phase 8C local MVP trial pack, and Phase 8D template content QA are complete; Makeup Engine remains the template production system and the future user-facing app should be planned separately
...
- nextRecommendedPhaseName: MVP Release Readiness Gate
- project role: Makeup template production system with a local contract-driven user app shell prototype, not a production user app
- current capability: Phase 8D completed template content QA after Phase 8C completed local MVP trial pack, Phase 8B completed local PWA/mobile shell polish, and Phase 8A selected React Web / PWA MVP first
...
4. Whether to start Phase 8E or run a targeted 8D content QA follow-up
5. The exact handoff text for the next provider
```

## Required Handoff Rules

- Always state `lastCompletedPhase: 8D`.
- Always state `nextRecommendedPhase: 8E` unless the owner asks for a targeted 8D follow-up.
