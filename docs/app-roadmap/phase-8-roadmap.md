...
| 8B | PWA / Mobile Web MVP Polish | Polish the mobile-first PWA MVP brief, UX acceptance criteria, package consumption expectations, and trial-readiness checklist. | Planning and docs first. Do not add backend, database, camera, AR, native app, OpenAI API, training, ecommerce, community, paid, or production release scope. |
