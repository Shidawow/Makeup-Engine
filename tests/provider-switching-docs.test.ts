...
describe('provider switching docs', () => {
  ...
  it('provides phase 9H to 9I switch templates with historical 8E, 9A, and 9B markers', async () => {
    ...
    expect(prompt).toContain('Anonymous Internal Trial Evidence Review');
